...
export default function OpenedNav() {
  return (
    // 메뉴
    <div className='w-[240px] p-[12px]'>
      ...
      <div>
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] flex h-[40px]  bg-gray-200 rounded-md'>
            <div className='w-[48px] my-auto'>
            ...
            <div className='w-[132px] h-[20px] my-auto'>
              <p className='text-[14px] my-auto'>홈</p>
            </div>
        </div>
        {/* 메뉴 항목 끝 */}
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] flex h-[40px] rounded-md'>
            <div className='w-[48px] my-auto'>
              <div className='w-[24px] h-[24px]'>
    ...
    <div className='mt-[12px] py-[12px]'>
      <hr className='mb-[12px]'/>
        ...
        <div className='w-[204px] px-[12px] flex h-[40px] rounded-md'>
            ...
            <div className='w-[132px] h-[20px] my-auto'>
              <p className='text-[14px]'>나중에 볼 동영상</p>
            </div>
        </div>
        {/* 메뉴 항목 끝 */}
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] flex h-[40px] rounded-md'>
            ...
            <div className='w-[132px] h-[20px] my-auto'>
              <p className='text-[14px]'>좋아요 표시한 동영상</p>
            </div>
        </div>
        {/* 메뉴 항목 끝 */}
    </div>
    ...
    <div className='py-[12px]'>
      <hr className='mb-[12px]'/>
      <div className='w-[216px] h-[32px] px-[12px] pt-[6px] pb-[4px]'>
        <span className='text-[16px]'>탐색</span>
      </div>
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] flex h-[40px] rounded-md'>
            <div className='w-[48px] my-auto'>
            ...
            <div className='w-[132px] h-[20px] my-auto'>
              <p className='text-[14px]'>인기 급상승</p>
            </div>
        </div>
        {/* 메뉴 항목 끝 */}
        {/* 메뉴 항목 */}
    ...
    <div className='py-[12px]'>
      <hr className='mb-[12px]'/>
      <div className='w-[216px] h-[32px] px-[12px] pt-[6px] pb-[4px]'>
        <p className='text-[16px]'>YouTube 더보기</p>
      </div>
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] flex h-[40px] rounded-md'>
            <div className='w-[48px] my-auto'>
  ...
  <path fill="#FFF" d="M10.3,9.89c0,0,0.5,4.08,0.51,4.19c0.06-0.04,3.79-2.58,3.79-2.58C13.71,11.07,11.07,10.14,10.3,9.89z"></path>
    ...
    <div className='py-[12px]'>
      <hr className='mb-[12px]'/>
        ...
        <div className='w-[204px] px-[12px] flex h-[40px] rounded-md'>
            ...
            <div className='w-[132px] h-[20px] my-auto'>
              <p className='text-[14px] my-auto'>설정</p>
            </div>
        </div>
        {/* 메뉴 항목 끝 */}
        {/* 메뉴 항목 */}
        ...
        <div className='w-[204px] px-[12px] flex h-[40px] rounded-md'>
            ...
            <div className='w-[132px] h-[20px] my-auto'>
              <p className='text-[14px]'>의견 보내기</p>
            </div>
        </div>
        {/* 메뉴 항목 끝 */}
    </div>
    ...
    <div className='py-[12px]'>
      <hr className='mb-[12px]'/>
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px]'>
            <a href='/' className='text-[10px] '>정보</a>
            <a href='/' className='text-[10px]'>보도자료</a>
            <a href='/' className='text-[10px]'>저작권</a>
            <a href='/' className='text-[10px]'>문의하기</a>
            <a href='/' className='text-[10px]'>크리에이터</a>
            <a href='/' className='text-[10px]'>광고</a>
            <a href='/' className='text-[10px]'>개발자</a>
        </div>
        {/* 메뉴 항목 끝 */}
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] '>
            <a href='/' className='text-[10px]'>약관 개인정보처리방침</a>
            <a href='/' className='text-[10px]'>정책 및 안전</a>
            <a href='/' className='text-[10px]'>YouTube 작동의 원리</a>
            <a href='/' className='text-[10px]'>테스트하기</a>
        </div>
        {/* 메뉴 항목 끝 */}
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] '>
            <p className='text-[10px]'>© 2023 Google LLC, Sundar Pichai, 1600 Amphitheatre Parkway, Mountain View CA 94043, USA, 0807-882-594 (무료), yt-support-solutions-kr@google.com, 호스팅: Google LLC, 사업자정보, 불법촬영물 신고</p>
        </div>
        {/* 메뉴 항목 끝 */}
        {/* 메뉴 항목 */}
        <div className='w-[204px] px-[12px] '>
            <p className='text-[10px]'>크리에이터들이 유튜브 상에 게시, 태그 또는 추천한 상품들은 판매자들의 약관에 따라 판매됩니다. 유튜브는 이러한 제품들을 판매하지 않으며, 그에 대한 책임을 지지 않습니다.</p>
        </div>
        {/* 메뉴 항목 끝 */}        
    </div>
    {/* 6번째 메뉴 끝 */}
